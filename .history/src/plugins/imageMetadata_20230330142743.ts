 ...
 */
//The function uses a TypeScript type guard to narrow the type of the node argument to ImageNode. The node is ImageNode syntax tells TypeScript that if the node object satisfies the conditions in the following block, its type can be narrowed to ImageNode.
